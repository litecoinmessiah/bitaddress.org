ninja.translator = {
	...
	translations: {
		"en": {
			...
			"paperlabellitecoinaddress": "Litecoin Address:",
		...
		"es": {
			...
			"paperlabellitecoinaddress": "Dirección Litecoin:",
			...
			"generatelabellitecoinaddress": "Generando dirección Litecoin...",
			...
			"footerlabelcopyright1": "Copyright liteaddress.org.",
			...
			"singlelabellitecoinaddress": "Dirección Litecoin",
			...
			"brainlabellitecoinaddress": "Dirección Litecoin:",
			...
			"vanitylabellitecoinaddress": "Dirección Litecoin personalizada:",
			"vanitylabelnoteslitecoinaddress": "Esta es tu nueva dirección, que debería tener el prefijo deseado.",
			...
			"detaillabellitecoinaddress": "Dirección Litecoin:",
			"detaillabellitecoinaddresscomp": "Dirección Litecoin (comprimida):",
		...
		"fr": {
			...
			"paperlabellitecoinaddress": "Adresse Litecoin:",
			...
			"generatelabellitecoinaddress": "Création de l'adresse Litecoin...",
			...
			"singlelabellitecoinaddress": "Adresse Litecoin:",
			...
			"brainlabellitecoinaddress": "Adresse Litecoin:",
			...
			"vanitylabellitecoinaddress": "Adresse Litecoin Vanité:",
			"vanitylabelnoteslitecoinaddress": "Ci-haut est votre nouvelle adresse qui devrait inclure le préfix requis.",
			...
			"detaillabelnote1": "Votre Clé Privée Litecoin est un nombre secret que vous êtes le seul à connaître. Il peut être encodé sous la forme d'un nombre sous différents formats. Ci-bas, nous affichons l'adresse Litecoin et la Clé Publique qui corresponds à la Clé Privée ainsi que la Clé Privée dans les formats d'encodage les plus populaires (WIF, WIFC, HEX, B64, MINI).",
			...
			"detaillabellitecoinaddress": "Adresse Litecoin:",
			"detaillabellitecoinaddresscomp": "Adresse Litecoin (compressée):",
		...
		"el": {
			...
			"paperlabellitecoinaddress": "Διεύθυνση Litecoin:",
			...
			"generatelabellitecoinaddress": "Δημιουργία Διεύθυνσης Litecoin...",
			...
			"singlelabellitecoinaddress": "Διεύθυνση Litecoin:",
			...
			"brainlabellitecoinaddress": "Διεύθυνση Litecoin:",
			...
			"vanitylabellitecoinaddress": "Vanity Διεύθυνση Litecoin:",
			"vanitylabelnoteslitecoinaddress": "Παραπάνω είναι η διεύθυνσή σας που θα πρέπει να περιλαμβάνει το επιθυμητό πρόθεμα.",
			...
			"detaillabellitecoinaddress": "Διεύθυνση Litecoin:",
			"detaillabellitecoinaddresscomp": "Συμπιεσμένη Διεύθυνση Litecoin:",
	    ...
	    "it": {
			...
			"paperlabellitecoinaddress": "Indirizzo Litecoin:",
			...
			"generatelabellitecoinaddress": "Generazione Indirizzo Litecoin...",
			...
			"singleprint": "Stampa",
			"singlelabellitecoinaddress": "Indirizzo Litecoin:",
			...
			"brainlabellitecoinaddress": "Indirizzo Litecoin:",
			...
			"vanitylabellitecoinaddress": "Indirizzo del Vanity Wallet:",
			"vanitylabelnoteslitecoinaddress": "Sopra trovi il tuo nuovo indirizzo che dovrebbe includere il prefisso che hai scelto.",
			...
			"detaillabellitecoinaddress": "Indirizzo Litecoin",
			"detaillabellitecoinaddresscomp": "Indirizzo Litecoin compresso",
	    ...
	    "de": {
			...
			"paperlabellitecoinaddress": "Litecoin-Adresse:",
			...
			"generatelabellitecoinaddress": "Erstelle Litecoin-Wallet...",
			...
			"singleprint": "Drucken",
			"singlelabellitecoinaddress": "Litecoin-Adresse",
			...
			"singletip3": "Du kannst <b>Guthaben</b> zu deinem Wallet <b>hinzuf&uuml;gen</b>, indem du genau wie bei anderen &Uuml;berweisungen Litecoins an die Litecoin-Adresse deines Wallets schickst.",
			...
			"bulka1": "Bisher musste immer der offizielle Litecoin-Daemon, litecoind, auf dem Server installiert sein, damit man Litecoins auf seiner Webseite annehmen konnte. Viele Webhoster blockieren die Installation von litecoind. Au&szlig;erdem m&uuml;ssen die privaten Schl&uuml;ssel auf dem Server liegen, damit litecoind funktioniert, obwohl sie dort einfacher gestohlen werden k&ouml;nnen. Mit einem Massen-Wallet brauchst du nur noch die Litecoin-Adressen und nicht mehr zus&auml;tzlich die privaten Schl&uuml;ssel hochladen. Dadurch musst du dir keine Sorgen mehr machen, dass dein Litecoin-Wallet gestohlen werden k&ouml;nnte, wenn unberechtigt in deinen Server eingedrungen wird.",
			...
			"bulklabela2li5": "Deine Litecoins werden sicher in die Block-Chain aufgenommen. Mithilfe des urspr&uuml;nglichen Wallets vom ersten Schritt kannst du sie ausgeben.",
			...
			"brainlabellitecoinaddress": "Litecoin-Adresse:",
			...
			"vanitylabellitecoinaddress": "Personalisierte Litecoin-Adresse:",
			"vanitylabelnoteslitecoinaddress": "Die obige Litecoin-Adresse sollte den gew&uuml;nschten Pr&auml;fix enthalten.",
			...
			"detaillabellitecoinaddress": "Litecoin-Adresse:",
			"detaillabellitecoinaddresscomp": "Komprimierte Litecoin-Adresse:",
		...
		"cs": {
			...
			"paperlabellitecoinaddress": "Litecoin adresa:",
			...
			"brainalertpassphrasewarning": "Varování: Je důležité zvolit silné heslo, které je odolné proti útoku hrubou silou a krádeži vašich Litecoinů.",
			...
			"generatelabellitecoinaddress": "Generuji Litecoin adresu",
			...
			"singleprint": "Tisk",
			"singlelabellitecoinaddress": "Litecoin adresa",
			...
			"bulklabelq1": "Proč bych měl používat Hromadnou peněženku pro příjem Litecoinů na mé stránce?",
			"bulka1": "Tradiční způsob jak přijímat Litecoiny na vaší webové stránce vyžaduje instalaci oficiálního litecoin klienta (\"litecoind\"). Mnoho webhostingových společností neumožňuje tuto instalaci provést. Také běh litecoin démona na webovém serveru znamená, že soukromé klíče jsou uloženy na serveru a mohou být ukradeny. Pokud použijete Hromadnou peněženku, tak stačí na server nahrát pouze veřejnou litecoin adresu a ne soukromé klíče. Poté se nemusíte bát, že vaše Litecoiny budou ukradeny v případě napadení serveru.",
			"bulklabelq2": "Jakým způsobem mohou přijímat Litecoiny na mé stránce pomocí Hromadné peněženky?",
			...
			"bulklabela2li3": "Umožněte na vaší stránce platbu pomocí Litecoinu. Stačí vždy zobrazit jednu z vygenerovaných adres a uložit si ji u objednávky.",
			...
			"bulklabela2li5": "Litecoiny budou bezpečně převedeny v řetězci bloků. Pro spotřebování stačí kdykoliv naimportovat soubor vygenerovaný v prvním kroku.",
			...
			"brainlabellitecoinaddress": "Litecoin adresa:",
			...
			"vanitylabellitecoinaddress": "Litecoin adresa Vanity:",
			"vanitylabelnoteslitecoinaddress": "Výše je vaše nová adresa, která by měla obsahovat požadovaný začátek.",
			...
			"detaillabelnote1": "",
			"detaillabelnote2": "",
			"detaillabellitecoinaddress": "Litecoin adresa:",
			"detaillabellitecoinaddresscomp": "Komprimovaná litecoin adresa:",
		...
		"hu": {  // 02-MAR-2014 16:57
			...
			"paperlabellitecoinaddress": "Litecoin cím:",
			...
			"brainalertpassphrasewarning": "Figyelem: Fontos, hogy erős jelmondatot válasszon, mert különben a jelmondatot nyers erővel feltörhetik és a litecoinjait ellophatják.",
			...
			"generatelabellitecoinaddress": "A litecoin cím előállítása...",
			...
			"singlelabellitecoinaddress": "Litecoin cím:",
			...
			"singletip2": "<b>A pénztárca biztonságos megőrzése</b> érdekében nyomtassa ki vagy más módon rögzítse a litecoin címet és privát kulcsot. Fontos, hogy a privát kulcsból készítsen másolatot, és tárolja biztonságos helyen. Ez a webhely nem tud az ön privát kulcsairól. Ha ismeri a PGP-t, akkor egyben letöltheti az egész web lapot, és ellenőrizheti, hogy a webhely szerzője álatal írt valódi változatot töltötte-e le. Ehhez össze kell hasonlítania a HTML-ből képzett SHA1 zanzát a webhely láblécében hivatkozott, aláírt verzió történetben lévő SHA1 zanzával. Ha elhagyja/megfrissíti a webhelyet vagy megnyomja az 'Új cím előállítása' gombot, akkor egy új privát kulcs áll elő, és az előzőleg megjelenített privát kulcs elvész. A litecoin címhez tartozó privát kulcsot titokban kell tartani. Bárki, aki megszerzi ezt a kulcsot, el tudja költeni az ehhez a címhez tartozó összes litecoint. Ha kinyomtatja a pénztárcát, akkor tárolja egy villámzáras vízhatlan nylon-zacskóban. A papír pénztárcát tekintse úgy, mintha pénz lenne.",
			"singletip3": "<b>Pénzt úgy tehet</b> a pénztárcájába, hogy másokkal litecoinokat küldet erre a Litecoin címre.",
			...
			"bulklabelq1": "Miért jó a Tömeges pénztárca használata, ha Ön litecoint szeretne elfogadni a web-en?",
			"bulka1": "Ha Ön litecoint szeretne elfogadni a web-en, akkor a szokásos megoldás az, hogy installálja a hivatalos litecoin kliens démont (\"litecoind\"). Sok web szolgáltató nem támogatja a litecoin démon installálását. Ráadásul, ha a litecoin démont a web szerveren futtatja, akkor a privát kulcsai is a web szerveren lesznek tárolva, és a web szerver meghekkelésekor ellophatják őket. A Tömeges pénztárca használatakor csak a litecoin címeket kell feltölteni a web szerverre, a privát kulcsokat nem. Így nem kell aggódnia, hogy ellopják a litecoin pénztárcáját, ha betörnek a web szerverre.",
			...
			"bulklabela2li3": "Web helyének vásárlókosarába vegye fel a litecoinnal történő fizetés lehetőségét. Ha egy ügyfél litecoinnal kíván fizetni, akkor \"fizetési címként\" az adatbázis egyik címét jelenítse meg, és a megrendelés mellett ezt a címet tárolja.",
			...
			"bulklabela2li5": "Az Ön litecoinjai biztonságos módon gyűlnek a blokkláncon. Használja az 1. lépés során előállított eredeti pénztárcát, ha szeretné őket elkölteni.",
			...
			"brainlabellitecoinaddress": "Litecoin cím:",
			...
			"vanitylabellitecoinaddress": "Kérkedő Litecoin cím:",
			"vanitylabelnoteslitecoinaddress": "Fönt látható az ön új címe, mely magában foglalja a kívánt előtagot.",
			...
			"detaillabelnote1": "A Litecoin Privát Kulcs egy titkos szám, melyet csak Ön ismer. Számos különböző formátumban kódolható. Az alábbiakban megjelenítettük a a Privát Kulcshoz tartozó Litecoin Címet és Publikus kulcsot, valamint a Privát Kulcsot a legnépszerűbb kódolási formátumokban (WIF, WIFC, HEX, B64, MINI).",
			...
			"detaillabellitecoinaddress": "Litecoin cím:",
			"detaillabellitecoinaddresscomp": "Tömörített Litecoin cím:",
		...
		"jp": {	
			...
			"paperlabellitecoinaddress": "ビットコインアドレス",
			...
			"generatelabellitecoinaddress": "ビットコインアドレスを生成中...",
			...
			"newaddress": "新アドレス生成",
			"singleprint": "印刷",
			"singlelabellitecoinaddress": "ビットコインアドレス",
			...
			"bulka1": "以前はビットコインをサイトで受け付けたかったら、「litecoind」というビットコインのシステムサービスをサーバーにアップロードし、サーバー上で実行しなければいけませんでした。しかし、このやり方だとサーバーがハッキングされてしまった場合、プライベートキーも全て持って行かれてしまいます。大量に生成しておいて、ビットコインアドレスだけをサーバーにアップしておけば、プライベートキーを安全な場所に保管できます。",
			...
			"bulklabela2li4": "後は支払いの通知を受けないと注文を通すか否か分かりません。グーグルで「litecoin payment notification」と検索したら、SMS、メール、APIなどでビットコインの支払いがあった際教えてくれます。これをコードの中に組み込んで、支払いがあったら注文を通すようにもできます。手動で送金があったかを見る場合、blockchain.infoに行き、宛先のアドレスを入力すれば、取引履歴から送金の事実を確認できます。大体送金の30秒後に表示され、10分～1時間の間に「確認」されます。",
			...
			"brainlabellitecoinaddress": "ビットコインアドレス",
			...
			"vanitylabellitecoinaddress": "カスタムビットコインアドレス",
			"vanitylabelnoteslitecoinaddress": "ご希望された頭文字を持ったアドレスになっています。",
			...
			"detaillabellitecoinaddress": "ビットコインアドレス",
			"detaillabellitecoinaddresscomp": "ビットコインアドレス(圧縮)",
